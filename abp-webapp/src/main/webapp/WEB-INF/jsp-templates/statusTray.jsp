...
<head>
	...
	<script type="text/javascript" src="http://@abp-webapp.host@/abp/library/js/gogo/gbp/gbp_wtinit.js"></script>
	<script>
		dcsInit.enabled = false;
	</script>
	<script type="text/javascript" src="http://@abp-webapp.host@/abp/library/js/gogo/wtbase.js"></script>
	...
	<link rel="stylesheet" href="http://@abp-webapp.host@/abp/library/css/gbp/statustray.css" type="text/css" />
	<script type="text/javascript" src="http://@abp-webapp.host@/abp/library/js/gogo/shared/tools.js"></script>
	<script type="text/javascript" src="http://@abp-webapp.host@/abp/library/js/gogo/gbp/gbp.js"></script>
	<script type="text/javascript" src="http://@abp-webapp.host@/abp/library/js/gogo/abp/abp.js"></script>
	<script type="text/javascript" src="http://@abp-webapp.host@/abp/library/js/gogo/gbp/pages/statustray.js"></script>
...
<body id="statusTray" onLoad="setCookie();">
	<div id="surround">
		<div id="nav">
			<div class="navButton"><a href="javascript:openpath('splash.do')" onclick="closing=true;displayWebtrends('homePage');"><img src="http://@abp-webapp.host@/abp/library/images/gbp/statustray/bt_home.gif" alt="portal homepage"/></a></div>
			<div class="navButton"><a href="javascript:openpath('selfCare.do')" onclick="closing=true;displayWebtrends('myAccount');"><img src="http://@abp-webapp.host@/abp/library/images/gbp/statustray/bt_account.gif" alt="my account"/></a></div>
			
			<!-- added by Abhishek for defect ID 911 --> 
	    	<div class="navButton"><a href="javascript:openpath('customerCare.do')" onclick="closing=true"><img src="http://@abp-webapp.host@/abp/library/images/gbp/statustray/bt_care.gif" alt="customer care"/></a></div>
	    	<!-- added by Abhishek for defect ID 911 --> 
				...
				<div id="contentWrapper">
					<div id="serviceInfo" class="pill">
						...
						<div class="pillMid png">
							<img src="http://@abp-webapp.host@/abp/library/images/gbp/statustray/hd_service.gif" alt="service information"/>
							<p id="alerts"></p>
						</div>
		...
		<div id="flightInfo">
			<center>
				<img src="http://@abp-webapp.host@/abp/library/images/gbp/statustray/hd_flightinfo.gif" alt="flight information"/>
