...
<WISPAccessGatewayParam xmlns:xsi=”http://www.w3.org/2001/XMLSchema-instance xsi:noNamespaceSchemaLocation="http://airborne.gogoinflight.com/static/xsd/WISPAccessGatewayParam.xsd">
		<AuthenticationReply>
			...
			<LoginResultsURL>
https://airborne.gogoinflight.com/gbp/smartClientLogin.do;jsessionid=${jsessionid}
			</LoginResultsURL>
			<LogoffURL>
				http://airborne.gogoinflight.com/abp/page/aaaDeactivate.do?gbpsessionid=${jsessionid}
			</LogoffURL>
		</AuthenticationReply>
...
-->
    ...
    <head>
		...
		<script>
		var siteRoot='http://airborne.gogoinflight.com';
    ...
    <body id="activation">
        ...
        <div id="errorJap" class="errorMssg">
            ...
            <div class="buttonTray">
	           <a href="#" onclick="retryActivateAbp()"><img src="http://airborne.gogoinflight.com/abp/library/images/abp/retry.png" alt="&#12522;&#12488;&#12521;&#12452;" /></a>
	           <a href="#" onclick="showChat('/gbp/eChat.do');"><img src="http://airborne.gogoinflight.com/abp/library/images/abp/customer_care_techError.png" alt="&#12459;&#12473;&#12479;&#12510;&#12540;&#12469;&#12509;&#12540;&#12488;" /></a>
            </div>
           </div>
        </c:if>
    	...
    	<div id="errorFr" class="errorMssg">
            ...
            <div class="buttonTray">
	           <a href="#" onclick="retryActivateAbp()"><img src="http://airborne.gogoinflight.com/abp/library/images/abp/retry.png" alt="R&eacute;essayer"  /></a>
	           <a href="#" onclick="showChat('/gbp/eChat.do');"><img src="http://airborne.gogoinflight.com/abp/library/images/abp/customer_care_techError.png" alt="Service &agrave; la client&egrave;le"  /></a>
            </div>
    	</div>
    	</c:if>
        <div id="errorEng" class="errorMssg">
            ...
            <div class="content">
            	<p>We are unable to connect you at this time. Please retry (we will not charge your card) or contact customer care. </p>
            </div>
            <div class="buttonTray">
           <a href="#" onclick="retryActivateAbp()"><img src="http://airborne.gogoinflight.com/abp/library/images/abp/retry.png" alt="Retry" /></a>
           <a href="#" onclick="showChat('/gbp/eChat.do');"><img src="http://airborne.gogoinflight.com/abp/library/images/abp/customer_care_techError.png" alt="Customer Care" /></a>
            </div>
          </div>
